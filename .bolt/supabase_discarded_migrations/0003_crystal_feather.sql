/*
  # Video Queue Schema Updates
  
  1. Tables and Types
    - Safely creates video_status enum if not exists
    - Creates video_queue table with proper constraints
  
  2. Security
    - Enables RLS
    - Adds user-specific policies
...
-- Safely create video status type if it doesn't exist
DO $$ 
BEGIN
